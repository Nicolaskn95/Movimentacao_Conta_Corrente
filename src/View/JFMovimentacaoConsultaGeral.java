 ...
 * @author Alunos
 */
public class JFMovimentacaoConsultaGeral extends javax.swing.JFrame {

    /**
     * Creates new form JFMovimentacaoConsultaGeral
     */
    public JFMovimentacaoConsultaGeral() {
        initComponents();
    }
    
     public JFMovimentacaoConsultaGeral(String operacao) {
        initComponents();
        ConnectDAO objcon = new ConnectDAO() ;
        ResultSet movimentacaoRS;
        movimentacaoRS = objcon.consultaRegistroAgenciasRSBD("MOVIMENTACAO");
        jTable1.setModel(DbUtils.resultSetToTableModel(movimentacaoRS));
    ...
    if (printServices.length > 0) {
        ...
        RelatorioUtils.gerarRelatorioPDF(rootPane, jTable1, "Relatório de Movimentações"); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFMovimentacaoConsultaGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFMovimentacaoConsultaGeral().setVisible(true);
            }
        });
    }
