 ...
 * @author Alunos
 */
public class JFContaCorrenteConsultaGeral extends javax.swing.JFrame {

    /**
     * Creates new form JFContaCorrenteConsultaGeral
     */
    public JFContaCorrenteConsultaGeral() {
        initComponents();
    }
    
    public JFContaCorrenteConsultaGeral(String operacao) {
        initComponents();
        ConnectDAO objcon = new ConnectDAO() ;
        ResultSet contacorrenteRS;
        contacorrenteRS = objcon.consultaRegistroAgenciasRSBD("CONTACORRENTE");
        jTable1.setModel(DbUtils.resultSetToTableModel(contacorrenteRS));
    ...
    if (printServices.length > 0) {
        ...
        RelatorioUtils.gerarRelatorioPDF(rootPane, jTable1, "Relatório de Conta Correntes"); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFContaCorrenteConsultaGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFContaCorrenteConsultaGeral().setVisible(true);
            }
        });
    }
