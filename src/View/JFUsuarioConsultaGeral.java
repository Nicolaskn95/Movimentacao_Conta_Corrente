 ...
 * @author Alunos
 */
public class JFUsuarioConsultaGeral extends javax.swing.JFrame {

    /**
     * Creates new form JFUsuarioConsultaGeral
     */
    public JFUsuarioConsultaGeral() {
        initComponents();
    }
    
    public JFUsuarioConsultaGeral(String operacao) {
        initComponents();
        ConnectDAO objcon = new ConnectDAO() ;
        ResultSet usuarioRS;
        usuarioRS = objcon.consultaRegistroAgenciasRSBD("USUARIOS");
        jTable1.setModel(DbUtils.resultSetToTableModel(usuarioRS));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFUsuarioConsultaGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFUsuarioConsultaGeral().setVisible(true);
            }
        });
    }
